    ...
    if (isset($_POST["add"])){
        if (isset($_SESSION["cart"])){
            ...
            if (!in_array($_GET["id"],$item_array_id)){
                ...
                echo '<script>window.location="shops_session.php"</script>';
            }else{
                     ...
                     <ul>
                        <li>
					        <form action="index.php" method="get" target="_blank">
                              <button type="button" onclick="window.location.href='logout.php'"> <span class="far fa-user"></span></button>
                           </form>
						   </li>
                        
                       <a href="carts_session.php"><li class="toyscart toyscart2 cart cart box_1">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
               <ul class="navbar-nav ">
                  ...
                  <li class="nav-item active">
                     <a href="shops_session.php" class="nav-link">Shop Now</a>
                  </li>
				  <li class="nav-item">
                                ...
                                echo  '<div class="inner-men-cart-pro">';
                                 ...
                                 echo '<div class="info-product-price">';
                                    ...
                                    echo '</div>';
									 ...
									 ?>
									 <form method="POST" action="shops_session.php?action=add&id=<?php echo $row["id"]; ?>">
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="shops_session.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
