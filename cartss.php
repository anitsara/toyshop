            ...
            <?php
                ...
                if(!empty($_SESSION["cart"])){
                    ...
                    foreach ($_SESSION["cart"] as $key => $value) {
					 ...
					 $s="insert into prev(cid,pname,qty,total,pprice) values('{$cid}','{$pname}','{$quantity}','{$tprice}','{$pprice}')";
					 $r=mysqli_query($db,$s);
                    }
					   ?>
                        <tr>
                            ...
                            <td>  <div class="checkout-right-basket">
                              <button type="button" class="btn btn-primary btn-lg" onclick="location.href='checkout.php'">Checkout</button>
                           </div></td>
                        </tr>
                        <?php
...
<button type="button" class="btn btn-primary btn-lg" onclick="location.href='hist.php'">Purchase History</button>
    </div>
