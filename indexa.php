          ...
          <div class="container-fluid">
               <div class="hedder-up row">
                  <div class="col-lg-3 col-md-3 logo-head">
                     <h1><a class="navbar-brand" href="index.php">KIDDY SHOP</a></h1>
                  </div>
...
<section class="clients py-lg-4 py-md-3 py-sm-3 py-3" id="clients">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            <h3 class="title clr text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">Best Products</h3>
                           ...
                           <div class="least-w3layouts-text-gap">
                              <div class="row">
                                 ...
                                 <div class="mt-3 news-agile-text">
									...
									It is a nice experience with KIDDY Toys
                                    The toys of KIDDY are 100% friendly for children.
                                     My child is still using the toy.
                                    It is long lasting toys are used here.<span class="fas fa-quote-right"></span>
                                    </p>
