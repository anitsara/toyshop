            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
               <ul class="navbar-nav ">
                  ...
                  <li class="nav-item active">
                     <a href="shopf.php" class="nav-link">Shop Now</a>
                  </li>
				  <li class="nav-item">
               ...
               echo '<div class="left-ads-display col-lg-9">';
                  echo '<div class="row">';
                                ...
                                echo  '<div class="inner-men-cart-pro">';
                                      echo '<a href="single.php" class="link-product-add-cart">Quick View</a>';
                                    echo'</div>';
                                 echo '</div>';
                                 ...
                                 echo '<div class="info-product-price">';
                                    ...
                                    echo '</div>';
									 ...
									 ?>
									<form method="POST" action="shopf.php?action=add&id=<?php echo $row["id"]; ?>">
                                          <input type="text" name="quantity" value="1">
                                          <input type="hidden" name="hidden_name" value="<?php echo $row["product_name"]; ?>">
                                          <input type="hidden" name="hidden_price" value="<?php echo "Rs" . "&nbsp" . $row["price"] ?>">
